...
print('')
print('So Sánh:')
print('Histogram của BILL_AMT phân phối theo lệch phải')
print('--> Thể hiện sự ghi nợ với những khoản tiền ít dần về khoản to')
print()
print('Histogram của Pay_AMT phân bố chuẩn.')
print('--> Thể hiện sự thanh toán ở mức trung bình')
